...
export const metadata: Metadata = {
  title: "SevaSetu | Smart Resource Allocation Prototype",
  description:
    "AI-powered community need intelligence and fair volunteer orchestration for India-scale social impact.",
};
